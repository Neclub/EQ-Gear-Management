...
from inventory_parser.generate_log import fetch_recording, write_last_report_log
...
def main(argv: list[str] | None = None) -> int:
    ...
    raid_bis.add_argument(
        "--raid-bis",
        dest="include_raid_bis",
        action="store_true",
        default=True,
        help="Include Raid BiS sheet (default)",
    )
    raid_bis.add_argument(
        "--no-raid-bis",
        dest="include_raid_bis",
        action="store_false",
        help="Skip Raid BiS sheet and network catalog fetch",
    )
    p.add_argument(
        "--include-anniversary",
        action="store_true",
