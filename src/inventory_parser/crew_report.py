"""Build crew equipped-gear reports from multiple inventory dumps."""
...
def _equipped_slots(data: InventoryData) -> dict[str, EquippedItem]:
    """Equipped items for each crew gear slot (empty slots omitted)."""
