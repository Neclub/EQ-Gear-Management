...
From-source setup, CLI flags, `%LOCALAPPDATA%\EQGM\` caches, Raid BiS / Type 18/19 / Heroic AA internals, tests, and the GitHub Release pipeline: **[DEVELOPMENT.md](DEVELOPMENT.md)**. Adding a new EverQuest expansion: **[Expansion Update Plan](Expansion%20Update%20Plan/README.md)**.
