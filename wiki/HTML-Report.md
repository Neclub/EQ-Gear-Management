...
- **Quests & Achievements** — Missing Collections, Quests, Raid Achievements, Hunters, Slayer, Tradeskills, Heroic AA, Achievement Summary → [[Quests and Achievements]]
...
| **Character** dropdown | Toolbar (table tabs, Type 7/8 Augs, Type 5 Augs, and Raid BiS) | Filter Missing Spells, Missing Useful Spells, Raid Achievements, Hunters, Slayer, Tradeskills, Missing Collections, Quests, etc. to one character; on **Type 5 Augs** / **Type 7/8 Augs** / **Raid BiS**, filter to one persona |
